...
namespace DataAccessLayer
{
    ...
    public partial class TestVariousInfoEntities : DbContext
    {
        public TestVariousInfoEntities()
            : base("name=TestVariousInfoEntities")
        {
        }
        ...
        [DbFunction("TestVariousInfoEntities", "SplitString")]
        public virtual IQueryable<SplitString_Result> SplitString(string input, string character)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<SplitString_Result>("[TestVariousInfoEntities].[SplitString](@Input, @Character)", inputParameter, characterParameter);
        }
